...
/**
 * Created by Chaoguo.Cui on 16/5/6.
 */
public class Framework {
  ...
  public static void export(final Object service, int port) throws Exception {
    ...
    for (; ; ) {
      try {
        new Thread(new RpcServer(service, server.accept())).start();
      } catch (Exception e) {
        e.printStackTrace();
      }
    }
  ...
  static class RpcServer implements Runnable {
    ...
    public RpcServer(Object service, Socket socket) throws IOException {
   ...
   * @throws Exception
   */
  @SuppressWarnings("unchecked") public static <T> T refer(final Class<T> interfaceClass,
    ...
    public Object invoke(Object proxy, Method method, Object[] arguments) throws Throwable {
      ...
      try {
        ...
        try {
          ...
          System.out
            .println("method.getParameterTypes() -> " + arrayToString(method.getParameterTypes()));

          output.writeObject(arguments);
          System.out.println("arguments -> " + arrayToString(arguments));
